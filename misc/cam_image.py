...
def get_args():
    ...
    parser.add_argument("--image-path", type=str, default=None, help="Input image path")
    parser.add_argument(
        "--output-image-path", type=str, default=None, help="Output image path"
    )
...
if __name__ == "__main__":
    ...
    if args.model == "resize":
        ...
        model = getattr(timm.models, args.model)(
            pretrained=("resnet" not in args.model)
        )
    if "resnet" in args.model:
        ...
        checkpoint = torch.hub.load_state_dict_from_url(
            url=rsb_300epoch_dict[args.model], map_location="cpu", check_hash=True
        )
    ...
    if args.image_path:
        ...
        image_url = (
            "http://146.48.86.29/edge-mac/imgs/n02123045/ILSVRC2012_val_00023779.JPEG"
        )
